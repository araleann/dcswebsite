			...
			<div class = 'row-fluid'>
				<div class = 'span4' id = 'sidebar'>
					<ul class = 'nav nav-list affix-top' data-spy = 'affix'>
						...
						<li class = 'nav-header'><a href = '#vision'>Vision</a></li> 
						<li class = 'nav-header'><a href = '#mission'>Mission</a></li> 
				...
				<div class = 'span7'>
					...
					<section id = 'corp'>
						<img class = 'img-polaroid corp pull-right' alt="lol accenture logo PLEASE CHANGE" alt = "let me tell you about Homestuck." src = "<?php echo base_url('/files/lab_logos/jane.jpg'); ?>" ></img>
