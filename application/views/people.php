			...
			<div class = 'row-fluid'>
				<div class = 'span4' id = 'sidebar'>
					<ul class = 'nav nav-list affix-top' data-spy = 'affix'>
						<li class = 'nav-header'><a href = '#faculty'>Faculty</a></li> 
						<li class = 'nav-header'><a href = '#staff'>Staff</a></li>
...
<!-- Load Footer-->
<?php $this->load->view('includes/footer', array('tag' => 'people')); ?>
