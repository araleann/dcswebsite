...
(function($){
	...
	$(document).ready(function() {
		$('div.image-slider').append('<div id="supersized-loader"></div><ul id="supersized"></ul>');
	});
		...
		base.nextSlide = function(){
	    	...
	    	switch(base.options.transition){
	    		...
	    		case 1: case 'fade':	// Fade
	    		    nextslide.animate({opacity : 0},0, 'easeOutSine').css('visibility','visible').animate({opacity : 1, avoidTransforms : false}, base.options.transition_speed, 'linear', function(){ base.afterAnimation(); });
	    		    break;
